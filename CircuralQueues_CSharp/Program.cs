...
namespace CircuralQueues_CSharp
{
    class Queues
    {
        ...
        public Queues()
        {
            /*Initial the values of the variables REAR and FRONT to -1 to indicate that the queue is initially empty. */
            FRONT = -1;
            REAR = -1;
        }
        public void insert(int element)
        {
            ...
            {
                Console.WriteLine("/nQueue overflow\n");
                return;
            }
            ...
            {
                /*if REAR is at the last position of the array, then the value of REAR is set to 0 that coresponds to the first position of the array. */
                if (REAR == max - 1)
                    REAR = 0;
                else
        ...
        public void remove()
        {
            ...
            {
                /*if the element to be deleted is at the last position of the array, then the value of FRONT is set to 0 i,e to the first element of the arrray.*/
                if (FRONT == max - 1)
                    FRONT = 0;
                else
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    Console.WriteLine("1. Implement insert opertaor");
                    Console.WriteLine("2. Implement delete operator");
